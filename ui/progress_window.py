...
class ProgressWindow:
    ...
    def setup_ui(self):
        ...
        operation_label = ttk.Label(main_frame, textvariable=self.operation_var, font=("TkDefaultFont", 12, "bold"))
        ...
        # Cancel button
        ttk.Button(main_frame, text=t.get("cancel_button"), command=self.cancel).pack()
