...
class Translator:
    ...
    def _detect_system_language(self):
        ...
        # Method 4: Fallback to locale.getlocale() with default category
        try:
    ...
    def __init__(self):
        ...
        self.translations = {
            "en": {
                ...
                "selected": "Selected",
                "source_duplicates": "Source Duplicates",
                "destination_duplicates": "Destination Duplicates",
                "last_updated": "Last Updated",
                "update_index": "Update Index",
                "multiple_indices_found": "Multiple Indices Found",
                "select_indices_to_update": "Select indices to update:",
                # Results and Actions
